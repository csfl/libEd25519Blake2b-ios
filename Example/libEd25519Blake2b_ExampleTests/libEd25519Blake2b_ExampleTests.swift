//
//  libEd25519Blake2b_ExampleTests.swift
...
class libEd25519Blake2b_ExampleTests: XCTestCase {
    ...
    func testBase() {
        ...
        let (secretKey, publicKey) = Ed25519.generateKeypair()
        let signature = Ed25519.sign(message: message, secretKey: secretKey, publicKey: publicKey)
        let ret = Ed25519.signOpen(message: message, publicKey: publicKey, signature: signature)
        XCTAssert(ret)
    }
    ...
    func testMore() {
        ...
        for i in 0..<messages.count {
            ...
            let pk = Ed25519.publicKey(secretKey: secretKey)
